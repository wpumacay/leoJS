...
var leojs;
(function (leojs) {
    var RDHmodelKukaKR210 = /** @class */ (function (_super) {
        __extends(RDHmodelKukaKR210, _super);
        function RDHmodelKukaKR210(world) {
            var _this = _super.call(this, world) || this;
            _this.m_ikEEPosRef = new core.LVec3(0, 0, 0);
            _this.m_ikWCPosRef = new core.LVec3(0, 0, 0);
            _this.m_ikEErotMat = new core.LMat4();
            _this.m_ikWCrotMat = new core.LMat4();
            _this.m_ikEEtoWCrot = new core.LMat4();
            _this.m_ikEEtoWCinvrot = new core.LMat4();
            _this.m_R_0_3 = new core.LMat4();
            _this.m_R_0_3_inv = new core.LMat4();
            _this.m_R_3_6 = new core.LMat4();
            // Relative transform to place end effector mesh in the correct orientation
            core.LMat4.copy(_this.m_ikEEtoWCrot, core.ROT_Y_90);
            core.inversePureRotationMat44InPlace(_this.m_ikEEtoWCinvrot, _this.m_ikEEtoWCrot);
            return _this;
        }
        RDHmodelKukaKR210.prototype._buildDHrepresentation = function () {
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_1', [true, true, true, false], [0, 0, 0.75, 0], core.radians(-185), core.radians(185)));
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_2', [true, true, true, false], [-0.5 * Math.PI, 0.35, 0, 0], core.radians(-45), core.radians(85), 1, -0.5 * Math.PI));
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_3', [true, true, true, false], [0, 1.25, 0, 0], core.radians(-210), core.radians(155 - 90)));
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_4', [true, true, true, false], [-0.5 * Math.PI, -0.054, 1.5, 0], -Math.PI, Math.PI));
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_5', [true, true, true, false], [0.5 * Math.PI, 0, 0, 0], core.radians(-125), core.radians(125)));
            this.m_dhTable.appendEntry(new leojs.RDHentry('joint_6', [true, true, true, false], [-0.5 * Math.PI, 0, 0, 0], -Math.PI, Math.PI));
        };
        RDHmodelKukaKR210.prototype.includeInvKinEndEffectorOrientation = function () {
            // Use the end effector rotation in IK solver, as the ...
            // wrist orientation should be calculated
            return true;
        };
        RDHmodelKukaKR210.prototype._computeEndEffectorOffset = function () {
            this.m_eeOffset = new core.LVec3(0, 0, 0.193 + 0.11);
            this.m_endEffectorCompensation = core.LMat4.translation(this.m_eeOffset);
            this.m_endEffectorCompensation = core.mulMatMat44(this.m_endEffectorCompensation, core.ROT_Y_90);
        };
        RDHmodelKukaKR210.prototype._computeMinMaxEstimates = function () {
        ...
        RDHmodelKukaKR210.prototype.inverse = function (xyz, rpy) {
            var _q1, _q2, _q3, _q4, _q5, _q6;
            // Extract info from dh table
            var _d1 = this.m_dhTable.entries()[0].getParamValue(leojs.DHparams.d_i);
            var _a1 = this.m_dhTable.entries()[1].getParamValue(leojs.DHparams.a_i_1);
            var _a2 = this.m_dhTable.entries()[2].getParamValue(leojs.DHparams.a_i_1);
            var _a3 = this.m_dhTable.entries()[3].getParamValue(leojs.DHparams.a_i_1);
            var _d4 = this.m_dhTable.entries()[3].getParamValue(leojs.DHparams.d_i);
            ...
            core.mulMatMat44InPlace(this.m_ikWCrotMat, this.m_ikEErotMat, this.m_ikEEtoWCinvrot);
            ...
            var _phi1, _phi2, _phi3, _phi4;
            _phi1 = Math.atan2(_a1, _d1);
            _phi2 = Math.atan2(this.m_ikWCPosRef.z, Math.sqrt(this.m_ikWCPosRef.x * this.m_ikWCPosRef.x +
            ...
            var _c1 = Math.cos(_q1);
            var _s1 = Math.sin(_q1);
            var _c23 = Math.cos(_q2 + _q3);
            var _s23 = Math.sin(_q2 + _q3);
            ...
            core.inversePureRotationMat44InPlace(this.m_R_0_3_inv, this.m_R_0_3);
            core.mulMatMat44InPlace(this.m_R_3_6, this.m_R_0_3_inv, this.m_ikWCrotMat);
            //// Compute q4, q5 and q6 from R_3_6 using the FK decomposition for T_3_6
            var _r33 = this.m_R_3_6.get(2, 2);
            var _r13 = this.m_R_3_6.get(0, 2);
            var _r23 = this.m_R_3_6.get(1, 2);
            var _r22 = this.m_R_3_6.get(1, 1);
            var _r21 = this.m_R_3_6.get(1, 0);
            ...
            var _joints = [_q1, _q2, _q3, _q4, _q5, _q6];
        ...
        RDHmodelKukaKR210.prototype.isInWorkspace = function (xyz) {
            // TODO: Implement this part
            return false;
        };
        RDHmodelKukaKR210.prototype.update = function (dt) {
            ...
            if (_test) {
                ...
                if (this.m_visibility) {
                    engine3d.DebugSystem.drawLine(core.ORIGIN, this.m_ikEEPosRef, core.YELLOW);
                    engine3d.DebugSystem.drawLine(core.ORIGIN, this.m_ikWCPosRef, core.MAGENTA);
                }
            }
        };
        return RDHmodelKukaKR210;
    }(leojs.RDHmodel));
    leojs.RDHmodelKukaKR210 = RDHmodelKukaKR210;
})(leojs || (leojs = {}));
